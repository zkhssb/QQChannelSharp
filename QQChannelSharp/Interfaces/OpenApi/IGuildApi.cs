...
namespace QQChannelSharp.Interfaces.OpenApi
{
    public interface IGuildApi
    {
        ...
        /// <returns></returns>
        Task<HttpResult<Guild>> GetGuildAsync(string guildId);
        /// <summary>
        /// 获取频道成员
        /// </summary>
        /// <param name="guildId">频道ID</param>
        ...
        /// <returns></returns>
        Task<HttpResult<Member>> GetGuildMemberAsync(string guildId, string userId);
        /// <summary>
        /// 批量获取频道成员
        /// </summary>
        /// <param name="guildId">频道ID</param>
        ...
        /// <returns></returns>
        Task<HttpResult<EmptyObject>> DeleteGuildMemberAsync(string guildId, string userId, MemberDeleteOptions? options = null);
        /// <summary>
        /// 频道禁言
        /// </summary>
        /// <param name="guildId">频道ID</param>
        ...
        /// <returns></returns>
        Task<HttpResult<EmptyObject>> GuildMuteAsync(string guildId, UpdateGuildMute mute);
    }
}
